...
* Other than grids with a contiguous square structure, some puzzles may include gaps, that don't contain a digit, such as in [Deconstruction puzzles](/constraints/deconstruction/README.md) and [One-Gap-Each puzzles](/constraints/one-gap-each/README.md).
...
* A sudoku is a [Latin Square](/constraints/latin-squares/README.md) with the additional constraint of regions.
